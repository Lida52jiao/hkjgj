...
//		}
	...
	@ResponseBody
	public String alter(String merChantId,String merName,String merMp,String agentStatus,String merType,
						Integer isNotUse,String merChantFee,String generationFee,
						String generationFeeRepayment, int time) {
		Transaction t=new Transaction();
		t.setMerChantId(merChantId);
		Transaction transaction=transactionService.findByObject(t);
		Num num = numService.gets(merType);
			...
			if(true){
				...
				h.setMerName(h.getMerName());
				h.setMerMp(merMp);
				h.setAgentStatus(agentStatus);
				h.setIsNotUse(isNotUse);
				if(!h.getMerType().equals(num.getMertype()) && Long.parseLong(h.getMerType()) < Long.parseLong(num.getMertype())){
...
//		model.addAttribute("app", appNameService.getList());
	...
	public String supplement(Model model,String merChantId,String name) throws UnsupportedEncodingException {
